...
searchField.addEventListener('keydown', async (e) => {
  if (e.key === 'Enter' && e.keyCode === 13 && e.target.value !== '') {
    ...
    const weatherData = await (0,_weatherReport__WEBPACK_IMPORTED_MODULE_0__.getWeatherData)(cityName);
    console.log(weatherData);
    (0,_degreeUnitConversion__WEBPACK_IMPORTED_MODULE_2__["default"])(weatherData);
    (0,_weatherDOM__WEBPACK_IMPORTED_MODULE_1__.generateCompleteWeather)(weatherData);
    searchField.value = '';
  }
});
...
const onLoadWeather = async () => {
  ...
  try {
    const londonBasicResponse = await (0,_weatherReport__WEBPACK_IMPORTED_MODULE_0__.getWeatherData)('London');
